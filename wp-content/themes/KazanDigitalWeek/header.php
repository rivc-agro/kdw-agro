  ...
  <div class="page-wrapper">
    <header class="header fix-blocks">
      <div class="site-container header__container">
        ...
        <a class="header__link testFile testFile" target="_blank" href="<?php echo carbon_get_theme_option('exposure_file' . carbon_lang()); ?>"><?php echo carbon_get_theme_option('exposure' . carbon_lang()); ?></a>
