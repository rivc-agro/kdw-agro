...
<section class="intro">
    ...
    <div class="site-container">
        <svg class="icon icon-scroll-by intro__scroll-by-icon" width="21" height="28">
            <use
                xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#scroll-by">
            </use>
        </svg>
                            ...
                            <defs>
                                <filter id="filter0_d_487_1260" x="0.390625" y="0.220215" width="647.949"
                                    ...
                                    <feColorMatrix type="matrix"
                                        values="0 0 0 0 0.572549 0 0 0 0 0.890196 0 0 0 0 0.662745 0 0 0 1 0" />
                                    <feBlend mode="normal" in2="BackgroundImageFix"
                                        result="effect1_dropShadow_487_1260" />
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_487_1260"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
        ...
        <ul class="forum__list grid-container js-anim-fade-out" data-intersection-ratio="0.15">
            ...
            <li class="forum__item">
                <svg class="icon icon-forum-img0 forum__item-img">
                    <use
                        xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#forum-img<?php echo $key; ?>">
                    </use>
                </svg>
            ...
            <div class="slider-nav">
                <button class="button-reset slider-nav__btn js-participants-btn-prev" aria-label="Следующий слайд">
                    <svg class="icon icon-arrow slider-nav__btn-icon" width="21" height="12">
                        <use
                            xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#arrow">
                        </use>
                    </svg>
                </button>
                        ...
                        <div class="participants__item swiper-slide">
                            <div class="participants__item-img-wrapper">
                                <picture>
                                    ...
                                    <img class="participants__item-img lazy"
                                    data-src="<?php echo $item_img; ?>"
                                    src="#" alt="<?php echo $item["name"]?> <?php echo $item["position"]?>">
                                </picture>
...
<section class="participants section-indent-padding">
    <div class="site-container participants__container">
        <h2 class="site-second-heading participants__heading js-animated-heading" data-text="2021" ><?php echo carbon_get_post_meta( $page_id, 'participants_title2'.carbon_lang() ); ?></h2>
        <div class="participants__slider-wrapper js-anim-fade-out">
            <div class="slider-nav">
                <button class="button-reset slider-nav__btn js-participants-btn-prev" aria-label="Следующий слайд">
                    <svg class="icon icon-arrow slider-nav__btn-icon" width="21" height="12">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            ?>
                                <div class="swiper-slide gallery__slide">
                                    <img class="lazy"
                                        data-src="<?php echo $gallery_imgs_src; ?>"
                                        src="#" alt="Галлерея изображение">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
...
<section class="shiled section-indent-padding js-anim-fade-out">
    <div class="site-container">
        <div class="shiled__container lazy"
            data-bg="<?php echo get_template_directory_uri(); ?>/assets/images/shield/bg.jpg"
            data-bg-fallback="<?php echo get_template_directory_uri(); ?>/assets/images/shield/bg.jpg">
            <p><?php echo carbon_get_theme_option( 'speeker_legend'.carbon_lang() );?></p>
            <button class="button-reset button shiled__btn" data-path="registration" data-reg-form="speeker"><span
                    class="_border-top"></span><span class="_border-bottom"></span><?php echo carbon_get_theme_option( 'speeker_became'.carbon_lang() );?></button>
        </div>
    </div>
</section>
        ...
        <div class="exposure__block js-anim-fade-out">
            ...
            <div class="exposure__slider js-exposure-slider swiper">
                <div class="swiper-wrapper">
                    ...
                    ?>
                        <img class="exposure__slide swiper-slide lazy"
                            data-src="<?php echo $exposure_imgs_src; ?>" src="#"
                            alt="">
                    <?php endforeach; ?>
                </div>
            </div>
        ...
        <div class="partners__list grid-container js-anim-fade-out">
            ...
            ?>
                <a class="partners__item" target="_blank" href="<?php echo $item["txt"]?>">
                    <img class="lazy"
                        data-src="<?php echo $item_img; ?>" src="#"
                        alt="">
                </a>
            <?php endforeach; ?>
        </div>
        ...
        <div class="map__content-block js-anim-fade-out">
            ...
            <p class="map__link">
                <svg class="icon icon-marker map__link-icon" width="24" height="24">
                    <use
                        xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#marker">
                    </use>
                ...
                <svg class="icon icon-tel map__link-icon" width="24" height="24">
                    <use
                        xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#tel">
                    </use>
                </svg>
                ...
                <svg class="icon icon-mail map__link-icon" width="24" height="24">
                    <use
                        xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#mail">
                    </use>
            ...
            <ul class="socials map__socials">
                <li class="socials__item"><a class="socials__link" href="<?php echo $GLOBALS['kdw']['vk']; ?>">
                        <svg class="icon icon-vk socials__link-icon" width="22" height="14">
                            <use
                                xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#vk">
                            </use>
                        </svg></a></li>
                <li class="socials__item"><a class="socials__link" href="<?php echo $GLOBALS['kdw']['tg']; ?>">
                        <svg class="icon icon-tg socials__link-icon" width="20" height="16">
                            <use
                                xlink:href="<?php echo get_template_directory_uri(); ?>/assets/images/sprites/sprite-mono.svg#tg">
                            </use>
                        </svg></a></li>
            </ul>
        </div>
